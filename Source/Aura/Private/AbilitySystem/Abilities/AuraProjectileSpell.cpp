...
void UAuraProjectileSpell::SpawnProjectile(const FVector& ProjectileTargetLocation)
{
	...
	// Rotation.Pitch = 0.f; // damit das Projectile immer parallel zum Boden fliegt
	...
	//Änderung wegen im Gesicht explodierender Projectiles
	//Statt GetOwningActorFromActorInfo() nehmen wir GetAvatarActorFromActorInfo()
